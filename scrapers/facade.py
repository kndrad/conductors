...
class IrenaFacade:
    ...
    an instance of Irena using this constructor; otherwise, it can be left as False and there will be no need for
    any additional code.
    """

    def __init__(self, username, password):
        self._irena = IrenaClient(username, password, authenticate=False)

    def make_authentication(self):
        return self._irena.authenticate()
    ...
    def timetable_allocations(self, date):
        ...
        Returns list of dictionaries:
            ...
            'end_hour': '23:58'}
        """
        factory = TimetableAllocationsResponseFactory(self._irena, date)
    ...
    def allocation_signature(self, title, date):
        ...
        """
        factory = AllocationSignatureResponseFactory(self._irena, title, date)
        try:
    ...
    def allocation_details(self, title, date):
        ...
        if not signature:
            ...
            factory = AllocationDetailsResponseFactory(self._irena, signature, date)
    ...
    def train_crew(self, train_number, date):
        ...
        """
        factory = CrewMembersResponseFactory(self._irena, train_number, date)
