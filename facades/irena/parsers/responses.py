...
class RequestResponseMarkupParser(abc.ABC):
...
class AllocationTimetableRequestResponseMarkupParser(RequestResponseMarkupParser):
    container_parser = AllocationContainerMarkupParser
...
class AllocationSignatureRequestResponseMarkupParser(RequestResponseMarkupParser):
    container_parser = None
...
class AllocationDetailsRequestResponseMarkupParser(RequestResponseMarkupParser):
    container_parser = AllocationDetailRowContainerMarkupParser
...
class TripCrewMembersRequestResponseMarkupParser(RequestResponseMarkupParser):
    container_parser = CrewMemberContainerMarkupParser
